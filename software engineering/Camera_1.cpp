...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		view = glm::lookAt(glm::vec3(camX, 0.0f, camZ), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(.0f, 1.0f, 0.0f));
		//view = glm::translate(view, glm::vec3(0.0f, 0.0f, -3.0f));
		projection = glm::perspective(glm::radians(100.0f), (float)width / height, 0.1f, 100.0f);
